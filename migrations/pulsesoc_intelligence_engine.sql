...
VALUES
    ('pulsesoc_discoveries', 'PulseSoc Discoveries',
     ...
     'platform', 'normal', 'digest', TRUE, TRUE, 62,
    ...
    ('market_pulse', 'Market Pulse',
     ...
     'markets', 'normal', 'digest', TRUE, TRUE, 72,
    ...
    ('world_pulse', 'World Pulse',
     ...
     'world', 'normal', 'digest', TRUE, TRUE, 80,
    ...
    ('pulsesoc_pulse', 'PulseSoc Pulse',
     ...
     'platform', 'normal', 'digest', TRUE, TRUE, 60,
    ...
    ('system_pulse', 'System Pulse',
     ...
     'system', 'high', 'realtime', TRUE, TRUE, 82,
