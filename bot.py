...
def prediction_samples():
    ...
    return [
        ...
        {"id": "eth-spot-flow-scenario", "title": "Will ETH see stronger spot-market demand this month?", "category": "Crypto", "status": "active", "outcomes": ["Yes", "No"], "probability": 49, "price": 0.49, "volume": 685000, "liquidity": 210000, "close_time": (now + timedelta(days=24)).isoformat(), "resolve_time": (now + timedelta(days=31)).isoformat(), "source": "educational_sample", "source_url": "", "risk_level": "Medium", "last_updated": now.isoformat()},
        {"id": "altcoin-liquidity-scenario", "title": "Will altcoin liquidity expand before the next macro data release?", "category": "Crypto", "status": "active", "outcomes": ["Expands", "Flat", "Contracts"], "probability": 43, "price": 0.43, "volume": 338000, "liquidity": 128000, "close_time": (now + timedelta(days=14)).isoformat(), "resolve_time": (now + timedelta(days=15)).isoformat(), "source": "educational_sample", "source_url": "", "risk_level": "High", "last_updated": now.isoformat()},
