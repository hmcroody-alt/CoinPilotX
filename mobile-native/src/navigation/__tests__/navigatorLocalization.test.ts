...
describe("navigator header titles", () => {
  it("finds the title options it is meant to be checking", () => {
    ...
    // every assertion below vacuously pass. 110 stack screens (incl. the three
    // Page OS routes, the Presence hub, and Watchlists + AssetDetail +
    // Portfolio) + 14 tabs, plus the `title` param the header passes when
