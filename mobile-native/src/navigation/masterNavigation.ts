...
export const masterNavigationSections: MasterNavigationSection[] = [
  {
    ...
    actions: [
      { label: "Home", route: "/pulse", status: "native", description: "PulseSoc Home and your feed." },
  ...
  },
  {
    ...
    actions: [
      ...
      { label: "Camera", route: "/pulse/camera/photo?target=feed", status: "native", description: "Open Camera Studio." },
      ...
      { label: "Courses", route: "/pulse/courses", status: "native", description: "Courses and learning." },
      { label: "Events", route: "/pulse/events", status: "native", description: "Events and scheduled Live sessions." }
    ]
  },
  {
    title: "Content",
    description: "Feed, reels, status, live, and media.",
    actions: [
      ...
      { label: "Live Viewer", route: "/pulse/live", status: "native", description: "Find and watch live streams." },
      { label: "Live Studio", route: "/pulse/live/studio", status: "native", description: "Check your camera, mic, and connection, then start your live broadcast in the app." },
      { label: "Pulse Radio", route: "/pulse/music#pulse-radio", status: "native", description: "PulseSoc Music, uploads, and the approved radio pool." }
    ]
  },
  {
    title: "Economy",
  ...
  },
  {
    ...
    actions: [
      ...
      { label: "System Status", route: "/dashboard/system/feed", status: "shell", description: "Opens the dashboard module view." }
    ]
  }
];
