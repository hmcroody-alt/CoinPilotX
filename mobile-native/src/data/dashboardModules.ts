...
export const dashboardModuleGroups: DashboardModuleGroup[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { key: "live_status", title: "Live Network", description: "Streams, viewers, encoder health, LiveKit, Mux, bitrate, recording, audio, and prediction.", route: "/dashboard/system/live", icon: "LV", status: "BETA", accent: "emerald", access: "active", actionLabel: "Review System" },
