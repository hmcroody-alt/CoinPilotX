    ...
    return (
      ...
      >
        ...
        <Panel>
          ...
          )) : <Text style={styles.muted}>The knowledge map for this lesson is on the lesson page on the PulseSoc website.</Text>}
        </Panel>
        <Panel>
        ...
        <Panel>
          ...
          {tutorAnswer ? <Text style={styles.answer}>{tutorAnswer}</Text> : <Text style={styles.muted}>Tutor answers come from the PulseSoc education AI and follow the same safety rules as the website.</Text>}
        </Panel>
    ...
    <FlatList
      ...
      ListEmptyComponent={
        <View style={styles.empty}>
          ...
          <Text style={styles.emptyText}>There are no lessons in this category yet. Try another category, or check back later.</Text>
        </View>
      }
    />
  );
