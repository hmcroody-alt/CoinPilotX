  ...
  return (
    <>
      ...
      <Panel>
        ...
        <Text style={styles.muted}>Choose which notifications you get, and how, in the Notification Preferences screen.</Text>
      </Panel>
  ...
  return (
    <>
      ...
      <Panel>
        ...
        {!state?.trustedDevices.length ? <Text style={styles.muted}>You have no trusted devices yet.</Text> : null}
