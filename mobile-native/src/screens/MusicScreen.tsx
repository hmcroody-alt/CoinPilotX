              ...
              <Pressable
                ...
                accessibilityLabel={
                  radio.status === "playing"
                    ? t("discovery:music.radioPauseLabel")
                    : radio.userWantsPlayback && radio.interruptedBy
                      ? t("discovery:music.radioKeepPausedLabel")
                      : t("discovery:music.radioPlayLabel")
                }
                accessibilityHint={
                  radio.userWantsPlayback && radio.interruptedBy
                    ? t("discovery:music.radioKeepPausedHint")
                    : t("discovery:music.radioHint")
                }
