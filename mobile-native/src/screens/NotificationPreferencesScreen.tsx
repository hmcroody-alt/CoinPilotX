  ...
  return (
    <ScrollView style={styles.root} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        <Text style={styles.title}>{t("common:screens.notificationPreferences")}</Text>
        <Text style={styles.subtitle}>{t("discovery:notifications.preferences.subtitle")}</Text>
      </View>
      <View style={styles.panel}>
        <Text style={styles.panelTitle}>{t("discovery:notifications.preferences.pushDevice")}</Text>
        <Text style={styles.muted}>{t("discovery:notifications.preferences.pushDeviceBody")}</Text>
