          ...
          ListHeaderComponent={
            loading && !visibleResults.length ? (
              ...
              <Text style={styles.resultCount}>
                {unsupportedTab
                  ? t("discovery:search.unsupportedTabCount")
                  : t("discovery:search.resultCount", { count: totalResults })}
              </Text>
            )
          }
          ListEmptyComponent={
            loading ? null : (
              <View style={styles.empty}>
                <Text style={styles.emptyTitle}>
                  {unsupportedTab ? t("discovery:search.unsupportedTabTitle") : t("discovery:search.emptyTitle")}
                </Text>
                <Text style={styles.emptyText}>
                  {unsupportedTab ? t("discovery:search.unsupportedTabBody") : t("discovery:search.emptyBody")}
                </Text>
              </View>
            )
          }
...
function EventsGatewayShortcut({ onPress }: { onPress: () => void }) {
  ...
  return (
    <Pressable style={styles.eventsGateway} onPress={onPress}>
      <Text style={styles.eventsGatewayKicker}>{t("discovery:search.nativeGateway")}</Text>
      <Text style={styles.eventsGatewayTitle}>{t("discovery:search.eventsGatewayTitle")}</Text>
      <Text style={styles.eventsGatewayText}>{t("discovery:search.eventsGatewayBody")}</Text>
    </Pressable>
  );
}
...
function LearningGatewayShortcut({ onPress }: { onPress: () => void }) {
  ...
  return (
    <Pressable style={styles.eventsGateway} onPress={onPress}>
      <Text style={styles.eventsGatewayKicker}>{t("discovery:search.nativeGateway")}</Text>
      <Text style={styles.eventsGatewayTitle}>{t("discovery:search.learningGatewayTitle")}</Text>
      <Text style={styles.eventsGatewayText}>{t("discovery:search.learningGatewayBody")}</Text>
    </Pressable>
  );
}
