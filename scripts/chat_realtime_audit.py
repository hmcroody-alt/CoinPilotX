...
def main():
    ...
    expect("Loading latest messages" in recovery_js and "Reconnecting..." in recovery_js, "specific realtime recovery copy is present")
    expect("Messages syncing" not in bot_source and "Messages syncing" not in recovery_js, "fake syncing loop copy is absent")
