...
def main() -> int:
    ...
    require('pulse_status_viewer.js?v=status-v3-20260629b" defer' in html, "core-safe /pulse defers the shared status runtime")
    ...
    require("global-media-ui-20260628g" in normal_html, "full profile references the current media renderer cache key")
    require("status-v3-20260629b" in normal_html, "full profile references the current status viewer cache key")
    require('pulse_media_renderer.js?v=global-media-ui-20260628g" defer' in normal_html, "full profile defers the media runtime")
    require('pulse_status_viewer.js?v=status-v3-20260629b" defer' in normal_html, "full profile defers the status runtime")
    ...
    for worker_url in ("/sw.js", "/static/service-worker.js"):
        ...
        require("coinplotx-cache-v19-pulse-offline-dashboard" in worker_text, f"service worker cache version is current {worker_url}")
