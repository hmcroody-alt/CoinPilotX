...
def main() -> int:
    ...
    require('pulse_status_viewer.js?v=status-gesture-command-20260621c" defer' in html, "core-safe /pulse defers the shared status runtime")
    ...
    require("status-gesture-command-20260621c" in normal_html, "full profile references the current status viewer cache key")
    require('pulse_media_renderer.js?v=global-media-ui-20260614a" defer' in normal_html, "full profile defers the media runtime")
    require('pulse_status_viewer.js?v=status-gesture-command-20260621c" defer' in normal_html, "full profile defers the status runtime")
