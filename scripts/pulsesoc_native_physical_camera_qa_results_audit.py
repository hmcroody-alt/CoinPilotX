...
def main() -> int:
    ...
    require_terms(
        ...
        [
            ...
            "adb devices -l",
            "Not run",
            "iPhone blocked by missing code-signing identity; Android not connected",
            "These remain simulator-verification results only.",
            "Do not move to Native LiveKit calls yet.",
            "configure iOS code signing for `com.pulsesoc.nativeapp`",
        ],
    )
    ...
    require_terms(
        ...
        [
            ...
            "blocked by missing local iOS code signing",
            "iPhone 16 Pro",
