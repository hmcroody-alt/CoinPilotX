...
def main():
    ...
    require(".pulse-live-now-card" in css and "grid-template-columns: 96px minmax(0, 1fr) !important" in css, "Live Now cards are compact on mobile")
    require(".pulse-live-preview" in css and "width: 96px !important" in css, "Live Now preview thumbnail is mobile-sized")
