...
require_local_database("undx_homepage_audit")
...
def main():
    ...
    for token in [
        "data-undx-core-page",
        "UNDX Core",
        "Unknown Destination X — the premium intelligence layer designed to help CoinPlotXAI build, analyze, secure, and evolve.",
        "Enter the Unknown Destination",
        "Premium Intelligence Layer",
        "Initialize UNDX Core",
        "View Core Modules",
        "Builder Intelligence Console",
        "Describe what you want CoinPlotXAI to build next, and UNDX will prepare the mission blueprint.",
        ...
        "UNDX Agent Council",
        "Eight routed intelligence agents evaluate each mission through the UNDX Intelligence Router before CoinPlotXAI enters the next build phase.",
        "Run Agent Council",
        "Architect Agent",
        "Research Agent",
        "Builder Agent",
        ...
        "Council Output",
        "UNDX Chat Interface",
        "Chat with UNDX and issue real mission directives powered by CoinPlotXAI intelligence.",
        ...
        "/file/read",
        "/proposal/generate",
        "UNDX Brain Layer is not active for this proposal response. Blocking legacy proposal output.",
        "/patch/apply",
        "/validate/run",
        "/git/status",
        "/git/commit",
