...
def main() -> None:
    ...
    require(bot, '"channel_id": "pulse-messages-v2"', "messages notification channel payload")
    ...
    require(comm_v2, '"channel_id": "pulse-messages-v2"', "V2 versioned messages channel payload")
    ...
    require(push, 'channel_id = "pulse-messages-v2"', "Expo versioned messages channel selection")
