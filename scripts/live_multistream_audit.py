...
require_local_database("live_multistream_audit")
...
def main():
    ...
    cur.execute(
        ...
        ("livemultiaudit", "Roody Cherie", "coinpilotxai@gmail.com", "/static/brand/pulsesoc-logo-20260913.png", "Multistream audit creator", now, now),
    )
