...
def main() -> int:
    ...
    checks = [
        ...
        check("Pulse pages load shared reaction CSS", "pulse_reaction_system.css?v=unified-reactions-20260629a" in bot),
        check("Pulse pages load shared reaction JS", "pulse_reaction_system.js?v=unified-reactions-20260629a" in bot),
