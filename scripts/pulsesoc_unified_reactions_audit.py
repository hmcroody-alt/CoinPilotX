...
def main() -> int:
    ...
    checks = [
        ...
        check("Pulse pages load shared reaction CSS", "pulse_reaction_system.css?v=feed-actions-v2-20260629b" in bot),
        check("Pulse pages load shared reaction JS", "pulse_reaction_system.js?v=feed-actions-v2-20260629b" in bot),
        check("Pulse pages load updated Status viewer JS", "pulse_status_viewer.js?v=feed-actions-v2-20260629b" in bot),
