...
for token in ['@webhook_app.route("/pulse/roast-battle"', "legacy_arena_roast_battle_redirect", 'redirect("/pulse/roast-battle"', "Live Battles", "Scheduled Battles", "Battle Replays", "Hall of Fame", "Audience Scoring", "pulse_roast_battle_shell_response", "Pulse Roast Battle"]:
