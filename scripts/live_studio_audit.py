...
def main():
    ...
    require("Browser Live is publishing through LiveKit and forwarding to Mux" in html, "studio explains Browser Live to LiveKit to Mux bridge")
    require("Stream Health Center" in html, "stream health center replaces dominant OBS block")
    require("Professional Streaming" in html and "<details" in html, "OBS/RTMP setup remains collapsible advanced backup")
