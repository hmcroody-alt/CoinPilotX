...
require_local_database("live_studio_audit")
...
def main():
    ...
    require("studio-pro-shell" in html and "studio-sidebar" in html, "premium studio shell and left navigation render")
    require("Studio</a>" in html and "Analytics" in html and "Revenue" in html and "Exit Studio" in html, "creator navigation exposes studio sections")
    ...
    require("data-live-advanced-panel hidden" in html, "advanced streaming details are hidden by default")
    require("Host stream key" in html and "data-secret-live-value" in html and "Reveal" in html, "stream key is masked behind an explicit reveal action")
    require("Stream Health Center" not in html, "technical health center is removed from default creator UI")
    require("Advanced Streaming" in html and "<details" in html, "OBS/RTMP setup remains collapsible advanced backup")
    require("studio-bottom-controls" in html and "Speaker Off" in html and "End Stream" in html, "bottom creator controls render")
    ...
    require("Audience Overview" in html and "Quick Actions" not in html or "Invite Guest" in html, "audience cards and quick actions render")
