...
def main() -> None:
    ...
    require(push, 'const ANDROID_MESSAGES_CHANNEL_ID = "pulse-messages-v2"', "versioned Android messages channel id")
    require(push, 'const ANDROID_LEGACY_MESSAGES_CHANNEL_ID = "messages"', "legacy Android messages channel compatibility")
    ...
    require(push, "payload.native_url || payload.app_url || payload.mobile_deep_link", "native notification URL preference")
    require(push, "pulse://pulse/messages-v2?conversation=", "messages-v2 exact conversation deep link")
