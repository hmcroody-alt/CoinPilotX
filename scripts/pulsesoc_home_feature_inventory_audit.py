...
FEATURES = [
    ...
    ("Notifications / Pulse Alerts", "/pulse/notifications", "top alert radar + rail", "/api/pulse/notifications", "wired"),
...
def main() -> int:
    ...
    checks = [
        ...
        check("Top nav old ! removed", "pulse-desktop-topbar" in home and "aria-label='Pulse Alert'" in home and ">!</" not in function_body(bot, "pulse_desktop_top_nav_html")),
