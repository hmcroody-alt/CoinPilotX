...
def main():
    ...
    ended = live_archive_service.replay_manifest({**live, "status": "ended", "ended_at": "2026-05-24T00:00:00", "recording_status": "replay_unavailable"}, [])
    require(ended["status"] == "unavailable" and ended["replay_available"] is False, "ended live without durable recording reports unavailable replay")
    ready = live_archive_service.replay_manifest({**live, "status": "ended", "ended_at": "2026-05-24T00:00:00", "replay_url": "https://cdn.coinpilotx.app/live/replay-audit.mp4"}, [])
    require(ready["status"] == "ready" and ready["replay_available"] is True, "ended live with CDN recording becomes replay-ready")
