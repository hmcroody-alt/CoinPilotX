...
def main() -> int:
    ...
    checks = [
        ...
        check("Active states styled", '[data-action="like"][aria-pressed="true"]' in feed_css and '[data-action="save"][aria-pressed="true"]' in feed_css and "reelActionPulse" in feed_css),
