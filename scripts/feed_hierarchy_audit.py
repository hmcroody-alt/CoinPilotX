...
def main() -> int:
    ...
    checks = [
        ...
        check("Attached audio card below media", render_post.find("renderPostMusic") > render_post.find("if (media) card.appendChild(media)")),
        ...
        check("CSS explicitly keeps owner header above media", ".post-card-modern .post-card-header" in feed_css and "order: 1 !important" in feed_css and ".post-card-modern > .post-card-media" in feed_css and "order: 4 !important" in feed_css),
