...
def main():
    ...
    require(".pulse-status-story-actions" in CSS and "width: 48px !important" in CSS and "opacity: .86 !important" in CSS, "side reactions are compact")
    ...
    require("status-edge-gesture-20260621a" in BOT, "status CSS/JS cache keys are bumped")
