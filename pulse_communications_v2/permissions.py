...
def can_view_conversation(user_id: int, conversation_id: int, context=None) -> bool:
    return bool(PULSE_COMMUNICATIONS_V2_ENABLED and user_id and conversation_id and context)
...
def can_manage_community(user_id: int, community_id: int, context=None) -> bool:
    return bool(PULSE_COMMUNICATIONS_V2_ENABLED and user_id and community_id and context)


def can_moderate_channel(user_id: int, channel_id: int, context=None) -> bool:
    return bool(PULSE_COMMUNICATIONS_V2_ENABLED and user_id and channel_id and context)
