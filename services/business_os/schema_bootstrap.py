...
_ENSURES = (
    ...
    ("suppliers", "services.business_os.suppliers.schema", "ensure_schema"),
    ("supplier_snapshots", "services.business_os.suppliers.gateway", "ensure_schema"),
    ("supplier_fulfillment", "services.business_os.suppliers.fulfillment", "ensure_schema"),
    ("supplier_quota", "services.business_os.suppliers.quota", "ensure_schema"),
    ("supplier_sync", "services.business_os.suppliers.worker", "ensure_schema"),
