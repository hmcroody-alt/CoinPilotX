...
NETWORK_SUBSYSTEMS = (
    {
        ...
        "description": "Queue, unread/read state, delivery status, preferences, retries, and safe link health.",
        ...
        "protection": "Safe delivery summaries are shown without exposing credentials, raw device data, or internal diagnostics.",
    ...
    },
    {
        ...
        "description": "Memberships, roles, join requests, community safety, and group health.",
        "intelligence": "Summarizes community health, pending invites, community updates, and group activity.",
        "automation": "Routes join requests, member roles, invites, and safety actions to the right queues.",
    ...
    },
    {
        ...
        "description": "Recent discussions, popular posts, momentum, trending communities, and safe discovery signals.",
        ...
        "recovery": "Activity timelines explain why recommendations changed.",
    },
    {
        "key": "network_health",
    ...
    },
    {
        ...
        "description": "Alerts, messages, realtime updates, retry, latency, and delivery health.",
        "intelligence": "Explains whether communication is flowing, delayed, retrying, or degraded.",
        "automation": "Coordinates retries, user-safe failure reasons, and recovery events.",
        "protection": "Delivery details are summarized safely without credentials, raw device data, or private URLs.",
        "recovery": "Retry queues and safe delivery diagnostics keep failed communication recoverable.",
    },
    {
    ...
    },
    {
        ...
        "description": "Message and alert reliability, delivery speed, recovery status, and communication health.",
        "intelligence": "Acts as the live delivery brain for communication health.",
        "automation": "Aggregates delivery reliability and recovery state into one owner-safe matrix.",
        "protection": "Only safe operational metrics are shown.",
        "recovery": "Delivery issues point to user-safe notification and message recovery actions.",
    },
    {
    ...
    },
    {
        ...
        "description": "Community health, growth, engagement, safety signals, and suggested improvements.",
        "intelligence": "Explains whether communities are healthy, growing, or need safer participation.",
        "automation": "Feeds group moderation, recommendations, and activity analytics.",
        "protection": "Private reports and internal review details stay hidden from users.",
    ...
    },
    {
        ...
        "intelligence": "Shows only user-visible restrictions and appeal-aware status.",
    ...
    },
    {
        ...
        "user_route": "/dashboard/network/delivery-intelligence",
        "action": "Manage Delivery",
        "description": "Device health, platform readiness, stale devices, and retry status.",
        ...
        "recovery": "Stale devices and delivery errors point to repair actions.",
    },
    {
        "key": "message-health",
...
def build_network_state(conn: Any, user: dict[str, Any]) -> dict[str, Any]:
    ...
    if failed_pushes:
        recommendations.append("Review notification settings so important alerts keep arriving.")
    if unread_messages:
    ...
    count_map = {
        ...
        "delivery_intelligence": delivery_health,
        ...
        "delivery_matrix": delivery_health + unread_messages + unread_notifications,
    ...
    detail_map = {
        ...
        "delivery_intelligence": f"{delivery_health}% delivery health and {push_devices} active device registrations.",
        ...
        "delivery_matrix": f"{unread_notifications} unread alerts, {unread_messages} unread conversations, {delivery_health}% delivery health.",
        ...
        "push-delivery": f"{delivery_health}% delivery health and {push_devices} active device registrations.",
    ...
    return {
        ...
        "metrics": {
            ...
            "delivery_attention": 1 if failed_pushes else 0,
        ...
        "event_bus": {
            ...
            "delivery_updates": unread_notifications + (1 if failed_pushes else 0),
