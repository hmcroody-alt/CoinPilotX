...
def page_meta(path="/"):
    path = path or "/"
    title_map = {
        "/": "CoinPilotXAI | AI Crypto Command Center and Alpha Arena",
    ...
    if "scam" in path:
        description = "Learn how to detect phishing, wallet drainers, fake giveaways, impersonation, and crypto scam patterns with CoinPilotXAI."
    return {
        "title": title,
