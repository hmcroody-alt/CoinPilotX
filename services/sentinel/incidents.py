...
INCIDENT_TYPES = (
    ...
    # Mission 5 financial incident types. Every one of these names a
    # SUSPICION or an OBSERVED INCONSISTENCY, never a verdict: ANOMALY is
    # not fraud, and no incident here can move, hold, or reverse money.
