...
AUTO_PK_TABLES = {
    ...
    "pulse_message_threads": "id",
    "pulse_conversations": "id",
    "pulse_conversation_participants": "id",
    "pulse_messages": "id",
    "pulse_message_reactions": "id",
    "pulse_message_reports": "id",
    "pulse_message_receipts": "id",
    "pulse_conversation_typing": "id",
    "comm_v2_conversations": "id",
    "comm_v2_participants": "id",
    "comm_v2_messages": "id",
    "comm_v2_attachments": "id",
    "comm_v2_live_streams": "id",
    "comm_v2_message_reactions": "id",
    "comm_v2_read_receipts": "id",
    "comm_v2_typing": "id",
    "comm_v2_reports": "id",
    "comm_v2_blocks": "id",
    "comm_v2_moderation_events": "id",
    "comm_v2_communities": "id",
    "comm_v2_channels": "id",
    "pulse_chat_rooms": "id",
    "pulse_chat_room_members": "id",
    "pulse_chat_room_messages": "id",
    "pulse_room_members": "id",
    "pulse_room_messages": "id",
    "live_events": "id",
    "live_ops_plans": "id",
    ...
    "pulse_status": "id",
    "pulse_statuses": "id",
    "pulse_status_views": "id",
    "pulse_status_reactions": "id",
    "pulse_status_replies": "id",
    "pulse_status_music": "id",
    "pulse_status_media": "id",
    "pulse_status_live": "id",
    "pulse_groups": "id",
    ...
    "pulse_ai_conversations": "id",
    "pulse_ai_messages": "id",
    "pulse_ai_knowledge_items": "id",
    "pulse_ai_user_memory": "id",
    "pulse_ai_feedback": "id",
    "pulse_ai_learning_events": "id",
    "pulse_ai_safety_reviews": "id",
    "pulse_ai_feature_registry": "id",
    "pulse_ai_conversation_context_permissions": "id",
    "pulse_ai_web_search_logs": "id",
    ...
    "ad_placements": "id",
    "ad_reports": "id",
    "pulse_ad_accounts": "id",
    "pulse_ad_campaigns": "id",
    "pulse_ad_creatives": "id",
    "pulse_ad_placements": "id",
    "pulse_ad_targeting": "id",
    "pulse_ad_impressions": "id",
    "pulse_ad_clicks": "id",
    "pulse_ad_events": "id",
    "pulse_ad_frequency_caps": "id",
    "pulse_ad_moderation_queue": "id",
    "pulse_ad_policy_flags": "id",
    "pulse_ad_audit_logs": "id",
    "pulse_ad_review_board": "id",
    ...
    "marketplace_listing_variants": "id",
    "marketplace_product_sources": "id",
    ...
    "pulse_live_clips": "id",
    "pulse_live_events": "id",
    "pulse_live_webrtc_signals": "id",
    "pulse_live_guest_requests": "id",
    "pulse_live_guests": "id",
    "pulse_reels": "id",
    ...
    "founder_memberships": "id",
    "premium_badges": "id",
    "founder_wall_entries": "id",
    ...
    "creator_tax_profiles": "id",
    "revenue_breakdown": "id",
    "fee_ledger": "id",
    "escrow_holds": "id",
    "platform_payouts": "id",
    "sponsor_slots": "id",
    ...
    "auth_events": "id",
    "communication_calls": "id",
    "communication_call_participants": "id",
    "communication_call_events": "id",
    "communication_call_quality_reports": "id",
    "communication_call_device_sessions": "id",
    "employees": "id",
    "departments": "id",
    "roles": "id",
    "permissions": "id",
