...
FEATURES: tuple[BackendFeature, ...] = (
    ...
    BackendFeature("network.calls", "Calls", "network", "/admin/calls", "admin", "system.view", "active", "Communications", "pulsesoc_communications_engine", "communication_call_events", "critical", True, True, "Voice/video call records, participants, Agora readiness, notifications, push delivery, timelines, quality reports, failures, and admin force-end diagnostics."),
...
FEATURES = FEATURES + (
    ...
    BackendFeature("system.agora", "Agora", "system", "/admin/pulse-infrastructure", "admin", "system.view", "active", "Live", "live_stream_health_service", "admin_tasks", "critical", True, True, "Agora configured/missing status is visible for live streaming operations."),
...
EXTERNAL_SERVICE_CHECKS: tuple[dict[str, Any], ...] = (
    ...
    {"key": "agora", "label": "Agora", "module": "system", "scope": "runtime", "env": ("AGORA_APP_ID", "AGORA_APP_CERTIFICATE")},
