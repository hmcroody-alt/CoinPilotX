...
_FEATURES = (
    ...
    FeatureSpec(
        ...
        implementation=IMPL_NOT_IMPLEMENTED,
        note=(
            "private_facts table + facts_service are not written yet. No feature "
            "code may write facts directly, so this stays NOT_IMPLEMENTED until "
            "the canonical writer exists."
        ),
    ),
    FeatureSpec(
