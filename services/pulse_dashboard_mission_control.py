...
SECTION_META = {
    ...
    "Intelligence": {"icon": "AI", "accent": "emerald", "label": "Intelligence"},
...
WIDGETS: list[dict[str, Any]] = [
    ...
    _widget("statuses", "Statuses", "Creator Studio", "/dashboard/creator/statuses", "Build and inspect immersive status stories.", sort_order=40),
    _widget("live_studio", "Live Studio", "Creator Studio", "/dashboard/creator/live-studio", "Go live or schedule a live creator session.", creator_required=True, sort_order=50, accent="red"),
    _widget("audience_analytics", "Audience Analytics", "Creator Studio", "/dashboard/creator/audience-intelligence", "Premium analytics for reach, retention, and followers.", premium_required=True, creator_required=True, sort_order=60, accent="purple"),
    _widget("content_performance", "Content Performance", "Creator Studio", "/dashboard/creator/content-performance", "Track posts, reels, videos, comments, and saves.", premium_required=True, creator_required=True, sort_order=70, accent="purple"),
    ...
    _widget("pulse_alerts", "Alerts", "Intelligence", "/pulse/intelligence", "Review high-confidence signals ranked by relevance, urgency, and your preferences.", sort_order=10, accent="emerald"),
    _widget("pulse_forecasts", "Forecasts", "Intelligence", "/pulse/forecasts", "See confidence-labeled forecasts only when trusted signals support them.", sort_order=20, accent="gold"),
    _widget("pulse_watchlists", "Watchlists", "Intelligence", "/dashboard/crypto/watchlists", "Track assets and topics you care about without changing alert ownership.", sort_order=30, accent="cyan"),
    _widget("pulse_advisor", "Pulse Advisor", "Intelligence", "/dashboard/intelligence/ai-advisor", "Ask for clear guidance based on safe PulseSoc knowledge and your approved settings.", sort_order=40, accent="purple"),
    _widget("security_signals", "Security Signals", "Intelligence", "/pulse/signals/security", "Review defensive security, patch, scam, and account protection signals.", sort_order=50, accent="emerald"),
    _widget("crypto_signals", "Crypto Signals", "Intelligence", "/pulse/signals/crypto", "Follow high-confidence crypto activity without investment recommendations.", sort_order=60, accent="gold"),
    _widget("market_signals", "Market Signals", "Intelligence", "/pulse/signals/market", "Follow major market and economic events without stock-by-stock noise.", sort_order=70, accent="cyan"),
    _widget("world_events", "World Events", "Intelligence", "/pulse/signals/world", "Review heavily filtered major world, science, emergency, and infrastructure events.", sort_order=80, accent="blue"),
    _widget("daily_briefing", "Daily Briefing", "Intelligence", "/pulse/briefing", "Scan the strongest available signals and forecasts in one compact briefing.", sort_order=90, accent="purple"),
    ...
    _widget("crypto_market_pulse", "Market Pulse", "Crypto Command Center", "/dashboard/crypto/market-pulse", "BTC, ETH, SOL, market health, sentiment, and provider freshness.", sort_order=10, accent="gold", status="BETA", tables=("alert_rules", "crypto_watchlists"), dependencies=("market-data",)),
    _widget("crypto_create_alert", "Create Alert", "Crypto Command Center", "/dashboard/crypto/alerts/create", "Create owner-scoped crypto price and 24h movement alerts.", sort_order=20, accent="emerald", tables=("alert_rules",), dependencies=("notifications",)),
    _widget("crypto_my_alerts", "My Alerts", "Crypto Command Center", "/dashboard/crypto/alerts", "Pause, resume, edit, delete, duplicate, and inspect your crypto alerts.", sort_order=30, accent="emerald", tables=("alert_rules",), dependencies=("notifications",)),
...
WIDGETS.extend([
    ...
    _widget("trend_intelligence", "Trend Intelligence", "Creator Studio", "/dashboard/creator/trend-intelligence", "Premium trend signals for creators.", premium_required=True, creator_required=True, sort_order=110, accent="purple", status="BETA", tables=("posts", "pulse_reels"), dependencies=("creator", "premium")),
    _widget("content_planner", "Content Planner", "Creator Studio", "/dashboard/creator/content-planner", "Plan future posts, reels, videos, and statuses.", premium_required=True, creator_required=True, sort_order=120, accent="purple", status="PARTIAL", tables=("dashboard_modules",), dependencies=("creator",)),
    _widget("post_scheduler", "Post Scheduler", "Creator Studio", "/dashboard/creator/post-scheduler", "Schedule future PulseSoc posts.", premium_required=True, creator_required=True, sort_order=130, accent="purple", status="PARTIAL", tables=("dashboard_modules",), dependencies=("creator",)),
    _widget("draft_studio", "Draft Studio", "Creator Studio", "/dashboard/creator/draft-studio", "Save and manage creator drafts.", premium_required=True, creator_required=True, sort_order=140, accent="purple", status="PARTIAL", tables=("dashboard_modules",), dependencies=("creator",)),
    _widget("ai_creator_assistant", "AI Creator Assistant", "Creator Studio", "/dashboard/creator/ai-creator-assistant", "AI support for captions and creator workflows.", premium_required=True, creator_required=True, sort_order=150, accent="purple", status="BETA", tables=("ai_conversations", "ai_messages"), dependencies=("ai", "creator")),
    _widget("engagement_prediction", "Engagement Prediction", "Creator Studio", "/dashboard/creator/engagement-prediction", "Predictive engagement estimates for creator content.", premium_required=True, creator_required=True, sort_order=160, accent="purple", status="PARTIAL", tables=("creator_dashboard_metrics",), dependencies=("creator", "ai")),
    ...
    for widget in WIDGETS:
        ...
        if item["category"] in unavailable_categories:
            ...
            try:
                ...
                elif item["category"] == "Intelligence":
