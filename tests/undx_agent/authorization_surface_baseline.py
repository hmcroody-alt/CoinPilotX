...
AUTHORIZATION_SURFACE: tuple[tuple[Any, ...], ...] = (
    ...
    ('presence.privacy.update', 'reversible_write', 'always', 'self_account_only', 'self_account_only', True, True, True, 'presence_privacy_value', ('enabled',), 'UNDX_AGENT_WRITES_ENABLED'),
